    ...
    <section className={styles.section}>
      <Container>
        <div className={styles.wrapper}>
          <Image className={styles.image} src='/images/news.jpg' alt='' width={535} height={360} />
          <div className={styles.content}>
            <h3 className={styles.heading}>
              Подпиши<span className={styles.danger}>те</span>сь на рассылку, <br /> чтобы следить
              за новостями VITA<span className={styles.alpha}>ME</span>
            </h3>
            <div className={styles.middle}>
              ...
              <button
                ...
                disabled={!isApproved || !formik.isValid || formik.values.email.length === 0}
                onClick={() => formik.handleSubmit()}
              >
                {isLoading ? <Loader /> : 'Подписаться'}
              </button>
            </div>
          </div>
        </div>
