...
const Form = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string().matches(/^[\w.-]+@[\w.-]+\.\w+$/, 'Please enter a valid email address')
    }),
      ...
      <div className={styles.content}>
        ...
        <div className={styles.inputs}>
          ...
          <Input
            ...
            maxLength={50}
            isValid={formik.errors.company !== 'Это название компании уже используется.'}
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
          />
          <Input
        ...
        >
          {isLoading ? <Loader /> : 'Оставить заявку'}
        </button>
      </div>
    </div>
  )
